...
function validateForm() {
    ...
    let region_name_data_num = document.forms["formCreate"]["txtRegionName"].value;
    if (region_name_data_num){
        for (region_data_name in region_name_data_num)
            if (region_data_name.isInteger){
